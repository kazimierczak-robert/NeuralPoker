...
class Model:
    ...
    def convert_input_to_one_hot(self):
        ...
        with tf.Session() as sess:
            for ith_column in range(0, self.dataset.on_board*2):
    ...
    def create(self):
        ...
        # 17 = 13 ranks + 4 suits
        input_layer = keras.layers.Input((17*self.dataset.on_board,))
        second_layer = keras.layers.Dense(7, activation=tf.nn.relu)(input_layer)
        if self.dataset.on_board == 2:
            ...
            output_1 = keras.layers.Dense(11, activation=tf.nn.softmax)(second_layer)
